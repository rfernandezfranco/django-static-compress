...
- Remove originals when `STATIC_COMPRESS_KEEP_ORIGINAL=False` and compressed variants are already up to date.
...
- Tests: Add coverage for removing originals when compressed variants are already up to date.
